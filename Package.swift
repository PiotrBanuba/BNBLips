...
let package = Package(
    ...
    products: [
        .library(
            ...
            targets: [
                "BNBLips",
                "BNBLipsBNBSdkCoreTarget",
                "BNBLipsBNBEffectPlayerTarget",
                "BNBLipsBNBScriptingTarget",
                "BNBLipsBNBFaceTrackerTarget"
            ]
        ),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target(
            name: "BNBLipsBNBEffectPlayerTarget",
            dependencies: [
                .product(
        ...
        .target(
            name: "BNBLipsBNBScriptingTarget",
            dependencies: [
                .product(
                    name: "BNBScripting",
        ...
        .target(
            name: "BNBLipsBNBFaceTrackerTarget",
            dependencies: [
                .product(
                    name: "BNBFaceTracker",
